...
var projectApi = __webpack_require__(9);
...
var onSignOut = function onSignOut(event) {
  ...
  .then(onClearAnimals()).catch(ui.signOutFailure);
};

var onGetAnimals = function onGetAnimals(event) {
  event.preventDefault();
  api.getAllAnimals().then(ui.getAnimalSuccess)
  // User can switch between "View All" and "View My" without hitting "Clear"
  .then(onClearAnimals()).catch(ui.getAnimalFailure);
};

var onGetUserAnimals = function onGetUserAnimals(event) {
  event.preventDefault();
  api.getUserAnimals().then(ui.getUserAnimalSuccess)
  // User can switch between "View All" and "View My" without hitting "Clear"
  .then(onClearAnimals()).catch(ui.getUserAnimalFailure);
};

var onAddAnimal = function onAddAnimal(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.addAnimal(data).then(ui.addAnimalSuccess)
  // clear the table after an animal is added
  .then(onClearAnimals()).catch(ui.addAnimalFailure);
};

var onUpdateAnimal = function onUpdateAnimal(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateAnimal(data).then(ui.updateAnimalSuccess)
  // clear the table after an animal is updated
  .then(onClearAnimals()).catch(ui.updateAnimalFailure);
};

var onClearAnimals = function onClearAnimals() {
  event.preventDefault();
...
var onDeleteAnimal = function onDeleteAnimal(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.deleteAnimal(data).then(ui.deleteAnimalSuccess)
  // clear the table after an animal is deleted
  .then(onClearAnimals()).catch(ui.deleteAnimalFailure);
};
...
var getUserAnimals = function getUserAnimals(data) {
  return $.ajax({
...
var addAnimal = function addAnimal(data) {
  return $.ajax({
    url: config.apiUrl + '/animals',
    method: 'POST',
    headers: {
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://mesa-list-server.herokuapp.com',
...
var store = __webpack_require__(3);
var showAnimalsTemplate = __webpack_require__(15);
var showUserAnimalsTemplate = __webpack_require__(32);
...
var getAnimalSuccess = function getAnimalSuccess(data) {
  $('#message').text('Successfully retrieved animals');
  $('#message').css('background-color', '#d5fdd5');
  var showAnimalsHtml = showAnimalsTemplate({
...
var getAnimalFailure = function getAnimalFailure(data) {
  $('#message').text('Failure retrieving animals');
  $('#message').css('background-color', '#ff6666');
};

var getUserAnimalSuccess = function getUserAnimalSuccess(data) {
  $('#message').text('Successfully retrieved animals');
  $('#message').css('background-color', '#d5fdd5');
  var showUserAnimalsHtml = showUserAnimalsTemplate({
    user: data.user
  });
...
var addAnimalSuccess = function addAnimalSuccess(data) {
...
var addAnimalFailure = function addAnimalFailure(data) {
  $('#message').text('Failure adding an animal');
  $('#message').css('background-color', '#ff6666');
};

var updateAnimalSuccess = function updateAnimalSuccess(data) {
  $('#message').text('Successfully updated database'); // Go back here and tell user which animal they updated
  $('#message').css('background-color', '#d5fdd5');
  global.clearForms();
};

var updateAnimalFailure = function updateAnimalFailure(data) {
  $('#message').text('Failure updating database');
  $('#message').css('background-color', '#ff6666');
  global.clearForms();
};

var deleteAnimalSuccess = function deleteAnimalSuccess(data) {
  $('#message').text('Successfully deleted');
  $('#message').css('background-color', '#d5fdd5');
  global.clearForms();
};

var deleteAnimalFailure = function deleteAnimalFailure(data) {
...
module.exports = {
  ...
  getAnimalSuccess: getAnimalSuccess,
  getUserAnimalSuccess: getUserAnimalSuccess,
  getAnimalFailure: getAnimalFailure,
  addAnimalSuccess: addAnimalSuccess,
  addAnimalFailure: addAnimalFailure,
  updateAnimalSuccess: updateAnimalSuccess,
  updateAnimalFailure: updateAnimalFailure,
  deleteAnimalSuccess: deleteAnimalSuccess,
  deleteAnimalFailure: deleteAnimalFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"handlebars\">\n<h1 data-id=\""
    ...
    + "  </li>\n  <li>Endangered Status: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.endangered : stack1), depth0))
    + "\n  </li>\n  </li>\n  <li>User:"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </li>\n</div>\n";
  ...
  return "\n    <a href=\"mailto:"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[1][0]) != null ? stack1.user : stack1)) != null ? stack1.email : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[1][0]) != null ? stack1.user : stack1)) != null ? stack1.email : stack1), depth0))
    + "</a>\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.animals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<h1 data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</small></h1>\n  <li>Animal ID:"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </li>\n  <li>Name:"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.name : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </li>\n  <li>Endangered Status: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.endangered : stack1), depth0))
    + "\n  </li>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n    "
    ...
    return "    No ID specified for this animal.\n";
},"6":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
  ...
  return "<div class=\"handlebars-mod\">\n  <p>Current user: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.email : stack1), depth0))
    + "\n  </p>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.animals : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n</div>\n";
},"useData":true,"useBlockParams":true});
...
var clearForms = function clearForms(data) {
  $('input[type=text]').val('');
  $('input[type=radio]').prop('checked', false);
